...
export const view: View<state.State, ActionsType> = (state, actions) => {
    ...
    areaData.forEach((area) => {
        ...
        // フレームを追加
        frameNodes.push(<components.AreaBackground left={area.left} top={area.top} width={area.width} height={area.height} cardCount={area.cardCountDisplay ? cards.length : null} />);
