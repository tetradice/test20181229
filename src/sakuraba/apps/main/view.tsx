...
const view: View<state.State, ActionsType> = (state, actions) => {
    ...
    ['p1', 'p2'].forEach((side: PlayerSide) => {
        ...
        state.board.megamiOpenFlags[side] &&
            state.board.megamis[side].find((megami) => megami === 'chikage' || megami === 'chikage-a1' || megami === 'kururu' || megami === 'thallya' || megami === 'raira' || megami === 'oboro' || megami === 'oboro-a1' || megami === 'honoka')){
            cardAreaData.push({
                  region: 'extra'
                , side: side
