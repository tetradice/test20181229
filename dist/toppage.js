...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/toppage.ts");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./node_modules/i18next-fetch-backend/dist/i18next-fetch-backend.esm.js":
/*!******************************************************************************!*\
  !*** ./node_modules/i18next-fetch-backend/dist/i18next-fetch-backend.esm.js ***!
  \******************************************************************************/
...
/***/ "./node_modules/i18next-multiload-backend-adapter/dist/commonjs/index.js":
/*!*******************************************************************************!*\
  !*** ./node_modules/i18next-multiload-backend-adapter/dist/commonjs/index.js ***!
  \*******************************************************************************/
...
var _utils = __webpack_require__(/*! ./utils.js */ "./node_modules/i18next-multiload-backend-adapter/dist/commonjs/utils.js");
...
/***/ "./node_modules/i18next-multiload-backend-adapter/dist/commonjs/utils.js":
/*!*******************************************************************************!*\
  !*** ./node_modules/i18next-multiload-backend-adapter/dist/commonjs/utils.js ***!
  \*******************************************************************************/
/*! no static exports found */
...
/***/ "./node_modules/i18next-multiload-backend-adapter/index.js":
/*!*****************************************************************!*\
  !*** ./node_modules/i18next-multiload-backend-adapter/index.js ***!
  \*****************************************************************/
/*! no static exports found */
...
module.exports = __webpack_require__(/*! ./dist/commonjs/index.js */ "./node_modules/i18next-multiload-backend-adapter/dist/commonjs/index.js").default;
...
Object.defineProperty(exports, "__esModule", { value: true });
var i18next_1 = __importStar(__webpack_require__(/*! i18next */ "./node_modules/i18next/dist/es/index.js"));
//import LocizeBackend from 'i18next-locize-backend';
var i18next_fetch_backend_1 = __importDefault(__webpack_require__(/*! i18next-fetch-backend */ "./node_modules/i18next-fetch-backend/dist/i18next-fetch-backend.esm.js"));
var i18next_multiload_backend_adapter_1 = __importDefault(__webpack_require__(/*! i18next-multiload-backend-adapter */ "./node_modules/i18next-multiload-backend-adapter/index.js"));
var moment = __webpack_require__(/*! moment */ "./node_modules/moment/moment.js");
$(function () {
    try {
        // 言語設定の初期化。初期化完了後にメイン処理に入る
        i18next_1.default
            .use(i18next_multiload_backend_adapter_1.default)
            .init({
            defaultNS: 'common',
            ...
            fallbackLng: false,
            backend: {
                backend: i18next_fetch_backend_1.default,
                backendOption: {
            ...
            if (tableHistory.length >= 1) {
                tableHistory.forEach(function (data) {
                    ...
                    $('.ui.accordion').append('<div class="title"><i class="dropdown icon"></i>' + i18next_1.t('toppage:TIMEに作成した卓', { time: moment(dt).format('YYYY/M/D HH:mm:ss') }) + '</div>');
                    $('.ui.accordion').append("<div class=\"content\">" + i18next_1.t('toppage:プレイヤー1の参加用URL') + ": <a target=\"_blank\" href=\"" + data.p1Url + '">' + data.p1Url + ("</a><br />" + i18next_1.t('toppage:プレイヤー2の参加用URL') + ": <a target=\"_blank\" href=\"") + data.p2Url + '">' + data.p2Url + ("</a><br />" + i18next_1.t('toppage:観戦用URL') + ": <a target=\"_blank\" href=\"") + data.watchUrl + '">' + data.watchUrl + '</a><br /></div>');
                });
                $('.ui.accordion').show();
            }
            else {
            ...
            $('#NEW-BOARD-BUTTON').click(function (e) {
                ...
                $.post('tables.create', function (data, textStatus) {
                    ...
                    $('.ui.accordion').prepend("<div class=\"content\">" + i18next_1.t('toppage:プレイヤー1の参加用URL') + ": <a target=\"_blank\" href=\"" + pushedData.p1Url + '">' + pushedData.p1Url + ("</a><br />" + i18next_1.t('toppage:プレイヤー2の参加用URL') + ": <a target=\"_blank\" href=\"") + pushedData.p2Url + '">' + pushedData.p2Url + ("</a><br />" + i18next_1.t('toppage:観戦用URL') + ": <a target=\"_blank\" href=\"") + pushedData.watchUrl + '">' + pushedData.watchUrl + '</a><br /></div>');
                    $('.ui.accordion').prepend('<div class="title"><i class="dropdown icon"></i>' + i18next_1.t('toppage:TIMEに作成した卓', { time: moment(pushedData.time).format('YYYY/M/D HH:mm:ss') }) + '</div>');
        ...
        console.error(ex);
        alert(i18next_1.t("システムエラーが発生しました。"));
        $.ajax({
            url: '/.error-send',
            type: 'post',
