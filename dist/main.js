...
/***/ "./node_modules/ts-serializer/dist/ts-serializer.js":
/*!**********************************************************!*\
  !*** ./node_modules/ts-serializer/dist/ts-serializer.js ***!
  \**********************************************************/
/*! no static exports found */
...
$(function () {
    ...
    function appendActionLog(text) {
        ...
        // socket.ioでサーバーに送信
        var log = new sakuraba.LogRecord();
        log.body = text;
        var param = { boardId: params.boardId, log: log };
    ...
    socket.on('send_first_board_to_client', function (receivingBoardData) {
        ...
        // ログ表示
        $('#ACTION-LOG-AREA').append(board.actionLog.map(function (log) { return log.body + "<br>"; }).join(''));
        $('#CHAT-LOG-AREA').append(board.chatLog.map(function (log) { return log.body + "<br>"; }).join(''));
    ...
    // ログが追加された
    socket.on('bc_append_action_log', function (socketParam) {
        // ログエリアに表示
        $('#ACTION-LOG-AREA').append(socketParam.log.body).append('<br>');
    });
    // チャットログが追加された
    socket.on('bc_append_chat_log', function (socketParam) {
        // ログエリアに表示
    ...
    $('#DECK-BUILD-BUTTON').click(function (e) {
        ...
        var selectedIds = [];
        selectedIds = selectedIds.concat(myBoardSide.library.map(function (c) { return c.id; }));
        selectedIds = selectedIds.concat(myBoardSide.specials.map(function (c) { return c.id; }));
        console.log(selectedIds);
        if (selectedIds.length >= 1) {
            var selector = selectedIds.map(function (id) { return "#DECK-BUILD-CARD-AREA [data-card-id=" + id + "]"; }).join(',');
    ...
    $('#HAND-SET-BUTTON').on('click', function () {
        confirmModal('手札を引くと、それ以降メガミやデッキの変更は行えなくなります。<br>よろしいですか？', function () {
...
Object.defineProperty(exports, "__esModule", { value: true });
var ts_serializer_1 = __webpack_require__(/*! ts-serializer */ "./node_modules/ts-serializer/dist/ts-serializer.js");
...
// クラス
var LogRecord = /** @class */ (function (_super) {
    __extends(LogRecord, _super);
    function LogRecord() {
        var _this = _super.call(this) || this;
        _this.created = moment().format();
        return _this;
    }
    __decorate([
        ts_serializer_1.SerializeProperty()
    ], LogRecord.prototype, "body", void 0);
    __decorate([
        ts_serializer_1.SerializeProperty()
    ], LogRecord.prototype, "created", void 0);
    __decorate([
        ts_serializer_1.SerializeProperty()
    ], LogRecord.prototype, "speaker", void 0);
    LogRecord = __decorate([
        ts_serializer_1.Serialize({})
    ], LogRecord);
    return LogRecord;
...
var Card = /** @class */ (function (_super) {
    ...
    __decorate([
        ts_serializer_1.SerializeProperty()
    ], Card.prototype, "used", void 0);
    __decorate([
        ts_serializer_1.SerializeProperty()
    ], Card.prototype, "sakuraToken", void 0);
    __decorate([
        ts_serializer_1.SerializeProperty()
...
var SpecialCard = /** @class */ (function (_super) {
    ...
    __decorate([
        ts_serializer_1.SerializeProperty()
    ], SpecialCard.prototype, "used", void 0);
    SpecialCard = __decorate([
        ts_serializer_1.Serialize({})
    ], SpecialCard);
    return SpecialCard;
}(Card));
exports.SpecialCard = SpecialCard;
var BoardSide = /** @class */ (function (_super) {
    __extends(BoardSide, _super);
    function BoardSide() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
    ...
    __decorate([
        ts_serializer_1.SerializeProperty()
    ], BoardSide.prototype, "playerName", void 0);
    __decorate([
        ts_serializer_1.SerializeProperty({ list: true })
    ], BoardSide.prototype, "megamis", void 0);
    __decorate([
        ts_serializer_1.SerializeProperty()
    ], BoardSide.prototype, "aura", void 0);
    __decorate([
        ts_serializer_1.SerializeProperty()
    ], BoardSide.prototype, "life", void 0);
    __decorate([
        ts_serializer_1.SerializeProperty()
    ], BoardSide.prototype, "flair", void 0);
    __decorate([
        ts_serializer_1.SerializeProperty()
    ], BoardSide.prototype, "vigor", void 0);
    __decorate([
        ts_serializer_1.SerializeProperty({ list: true, type: Card })
    ], BoardSide.prototype, "library", void 0);
    __decorate([
        ts_serializer_1.SerializeProperty({ list: true, type: Card })
    ], BoardSide.prototype, "hands", void 0);
    __decorate([
        ts_serializer_1.SerializeProperty({ list: true, type: Card })
    ], BoardSide.prototype, "used", void 0);
    __decorate([
        ts_serializer_1.SerializeProperty({ list: true, type: Card })
    ], BoardSide.prototype, "hiddenUsed", void 0);
    __decorate([
        ts_serializer_1.SerializeProperty({ list: true, type: Card })
    ], BoardSide.prototype, "specials", void 0);
    BoardSide = __decorate([
        ts_serializer_1.Serialize({})
    ], BoardSide);
    return BoardSide;
}(ts_serializer_1.Serializable));
...
var Board = /** @class */ (function (_super) {
    ...
    function Board() {
        ...
        _this.actionLog = [];
        _this.chatLog = [];
        _this.p1Side = new BoardSide();
        _this.p2Side = new BoardSide();
        return _this;
    }
    ...
    __decorate([
        ts_serializer_1.SerializeProperty()
    ], Board.prototype, "dataVersion", void 0);
    __decorate([
        ts_serializer_1.SerializeProperty()
    ], Board.prototype, "distance", void 0);
    __decorate([
        ts_serializer_1.SerializeProperty()
    ], Board.prototype, "dust", void 0);
    __decorate([
        ts_serializer_1.SerializeProperty()
    ], Board.prototype, "tokensOnCard", void 0);
    __decorate([
        ts_serializer_1.SerializeProperty({ list: true, type: LogRecord })
    ], Board.prototype, "actionLog", void 0);
    __decorate([
        ts_serializer_1.SerializeProperty({ list: true, type: LogRecord })
    ], Board.prototype, "chatLog", void 0);
    __decorate([
        ts_serializer_1.SerializeProperty({ type: BoardSide })
    ], Board.prototype, "p1Side", void 0);
    __decorate([
        ts_serializer_1.SerializeProperty({ type: BoardSide })
    ], Board.prototype, "p2Side", void 0);
    Board = __decorate([
        ts_serializer_1.Serialize({})
    ], Board);
    return Board;
